...
namespace MvcMovie.Controllers
{
    public class DailyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaDaiLy,TenDaiLy,DiaChi,MaHTPP,TenHTPP")] Daily daily)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaDaiLy,TenDaiLy,DiaChi,MaHTPP,TenHTPP")] Daily daily)
        {
            if (id != daily.MaDaiLy)
            {
                return NotFound();
